...
class TiendaOnline: 
    ...
    # Error: Se usaba {} como valor por defecto, haciendo que varias tiendas - 
    # pudieran compartir el mismo inventario. 
    # Solución: Se cambió {} por None y se creó un diccionario nuevo dentro de __init__. 
    ...
    def procesar_pedido(self, carrito, cupon_descuento=None): 
        ...
        # Error 02: El código original multiplicaba por 1.20 y aumentaba el precio.
        # Solución: Se cambia a 0.80 para aplicar correctamente el 20% de descuento.
